...
out1 = tf.layers.dense(o111_dp,1,name="head1_out",activation=None)
...
out2 = tf.layers.dense(o222_dp,1,name="head2_out",activation=None)
...
with tf.Session() as sess:
    ...
    for i in range(Epochs+1):
        for j in range(0,100): # Paragraphs from 100 to 104 are used for validation
            ...
            adv = reward_t - baseline # Advantage = Reward - baseline # np.array Batch,1,1
            ...
            training_loss, base,_ = sess.run([loss,baseline,train_op],feed_dict={ques_ph: Ques1,
                                                                                 para_ph: Paras,
                                                                                 drop_prob: 0.2})
