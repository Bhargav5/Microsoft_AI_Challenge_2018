...
Q = tf.layers.dropout(Q, rate=drop_prob, training=is_training_ph)
P = tf.layers.dropout(P, rate=drop_prob, training=is_training_ph)

Q = tf.layers.dense(Q, 512, activation=tf.nn.relu)
        ...
        for j in range(steps):
            ...
            if j % validation_at == 0:
                ...
                if current_val_acc > best_validation_acc:
                    ...
                    saver.save(sess, "./models/msaic_use_ce_attention_avg_v2_1_{}_{}.ckpt".format(i, j))
