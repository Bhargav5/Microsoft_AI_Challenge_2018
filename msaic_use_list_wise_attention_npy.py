...
print("Train Questions = {} Train Paragraphs = {} Train Answers = {}".format(train_ques.shape, train_paras.shape, len(train_ans)))
print("Test Questions = {} Test Paragraphs = {} Test Answers = {}".format(test_ques.shape, test_paras.shape, len(test_ans)))
...
#validation_acc = 0
#train_index = list(range(training_queries))
#print("Training index = {}".format(train_index[:10]))
            ...
            if j % validation_at == 0:
                ...
                for k in range(val_steps):
                    ...
                    if k1 + batch_size <= training_queries:
                        q_v = test_ques[k1: k1 + batch_size]
                        p_v = test_paras[k1: k1 + batch_size]
                        a_lt = test_ans[k1: k1 + batch_size]
                    else:
                        q_v = test_ques[k1: training_queries]
                        p_v = test_paras[k1: training_queries]
                        a_lt = test_ans[k1: training_queries]
