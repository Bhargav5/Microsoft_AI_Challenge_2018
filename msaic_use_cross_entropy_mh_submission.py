...
with tf.Session() as sess:
    ...
    saver.restore(sess=sess, save_path="./models/msaic_use_ce_lr_1e4mh_drop_40_0_1400.ckpt")
    for i in range(0,len(id_list),10):
        ...
        out = sess.run(y_out, feed_dict={ques_ph: ques_vec, paras_ph: paras_vec, drop_prob: 0.0, is_training_ph: False})
